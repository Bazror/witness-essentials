...
let config = convict({
  ...
  SMS_PROVIDER: {
    doc: 'Should there be an SMS alert after every missed?',
    format: ["nexmo", "twilio"],
    default: 'nexmo'
  },
  ...
  EMAIL_TO: {
    doc: 'Email-Adress from where the email will be send from',
    format: String,
    default: ''
  },
  EMAIL_FROM: {
    doc: 'Email-Adress from where the email will be send to',
    format: String,
    default: ''
  }
})
